...
describe('Component Hero', () => {
  it('should render without crashing', () => {
    const component = shallow(<Hero titleText='Lorem ipsum' imageSrc='bleeebleee' />);
  ...
  it('renders correct classNames', () => { //sprawdzimy, czy nasz wyrenderowany wrapper komponentu otrzymuje poprawne klasy, w zależności od propsa variant
